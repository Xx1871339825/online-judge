...
public enum ResultEnum {
    ...
    BAD_REQUEST_FILE_IS_EMPTY(40003,"result.badRequest.fileIsEmpty"),
    ...
    INTERNAL_SERVER_ERROR_NOT_JUDGE_SERVER(50003,"result.internal.serverError.notJudgeServer"),

    //不支持的语言
    INTERNAL_SERVER_ERROR_UNSUPPORTED_LANGUAGE(50004,"result.internal.serverError.unsupportedLanguage")
    ;
